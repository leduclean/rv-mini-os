...
#define TEST_ASSERT_BITS_HIGH(mask, actual)                                  \
	UNITY_TEST_ASSERT_BITS((mask), (UNITY_UINT)(-1), (actual), __LINE__, \
			       NULL)
#define TEST_ASSERT_BITS_LOW(mask, actual)                                  \
	UNITY_TEST_ASSERT_BITS((mask), (UNITY_UINT)(0), (actual), __LINE__, \
			       NULL)
...
#define TEST_ASSERT_UINT32_WITHIN(delta, expected, actual)             \
	UNITY_TEST_ASSERT_UINT32_WITHIN((delta), (expected), (actual), \
					__LINE__, NULL)
...
#define TEST_ASSERT_HEX16_WITHIN(delta, expected, actual)             \
	UNITY_TEST_ASSERT_HEX16_WITHIN((delta), (expected), (actual), \
				       __LINE__, NULL)
...
#define TEST_ASSERT_EQUAL_STRING_LEN(expected, actual, len)             \
	UNITY_TEST_ASSERT_EQUAL_STRING_LEN((expected), (actual), (len), \
					   __LINE__, NULL)
...
#define TEST_ASSERT_EQUAL_CHAR_ARRAY(expected, actual, num_elements) \
	UNITY_TEST_ASSERT_EQUAL_CHAR_ARRAY((expected), (actual),     \
					   (num_elements), __LINE__, NULL)
...
#define TEST_ASSERT_EACH_EQUAL_INT8(expected, actual, num_elements) \
	UNITY_TEST_ASSERT_EACH_EQUAL_INT8((expected), (actual),     \
					  (num_elements), __LINE__, NULL)
#define TEST_ASSERT_EACH_EQUAL_INT16(expected, actual, num_elements) \
	UNITY_TEST_ASSERT_EACH_EQUAL_INT16((expected), (actual),     \
					   (num_elements), __LINE__, NULL)
#define TEST_ASSERT_EACH_EQUAL_INT32(expected, actual, num_elements) \
	UNITY_TEST_ASSERT_EACH_EQUAL_INT32((expected), (actual),     \
					   (num_elements), __LINE__, NULL)
#define TEST_ASSERT_EACH_EQUAL_INT64(expected, actual, num_elements) \
	UNITY_TEST_ASSERT_EACH_EQUAL_INT64((expected), (actual),     \
					   (num_elements), __LINE__, NULL)
...
#define TEST_ASSERT_EACH_EQUAL_UINT8(expected, actual, num_elements) \
	UNITY_TEST_ASSERT_EACH_EQUAL_UINT8((expected), (actual),     \
					   (num_elements), __LINE__, NULL)
#define TEST_ASSERT_EACH_EQUAL_UINT16(expected, actual, num_elements) \
	UNITY_TEST_ASSERT_EACH_EQUAL_UINT16((expected), (actual),     \
					    (num_elements), __LINE__, NULL)
#define TEST_ASSERT_EACH_EQUAL_UINT32(expected, actual, num_elements) \
	UNITY_TEST_ASSERT_EACH_EQUAL_UINT32((expected), (actual),     \
					    (num_elements), __LINE__, NULL)
#define TEST_ASSERT_EACH_EQUAL_UINT64(expected, actual, num_elements) \
	UNITY_TEST_ASSERT_EACH_EQUAL_UINT64((expected), (actual),     \
					    (num_elements), __LINE__, NULL)
...
#define TEST_ASSERT_EACH_EQUAL_HEX8(expected, actual, num_elements) \
	UNITY_TEST_ASSERT_EACH_EQUAL_HEX8((expected), (actual),     \
					  (num_elements), __LINE__, NULL)
#define TEST_ASSERT_EACH_EQUAL_HEX16(expected, actual, num_elements) \
	UNITY_TEST_ASSERT_EACH_EQUAL_HEX16((expected), (actual),     \
					   (num_elements), __LINE__, NULL)
...
#define TEST_ASSERT_EACH_EQUAL_HEX64(expected, actual, num_elements) \
	UNITY_TEST_ASSERT_EACH_EQUAL_HEX64((expected), (actual),     \
					   (num_elements), __LINE__, NULL)
...
#define TEST_ASSERT_EACH_EQUAL_STRING(expected, actual, num_elements) \
	UNITY_TEST_ASSERT_EACH_EQUAL_STRING((expected), (actual),     \
					    (num_elements), __LINE__, NULL)
...
#define TEST_ASSERT_EACH_EQUAL_CHAR(expected, actual, num_elements) \
	UNITY_TEST_ASSERT_EACH_EQUAL_CHAR((expected), (actual),     \
					  (num_elements), __LINE__, NULL)
...
#define TEST_ASSERT_EACH_EQUAL_FLOAT(expected, actual, num_elements) \
	UNITY_TEST_ASSERT_EACH_EQUAL_FLOAT((expected), (actual),     \
					   (num_elements), __LINE__, NULL)
...
#define TEST_ASSERT_GREATER_OR_EQUAL_FLOAT(threshold, actual)           \
	UNITY_TEST_ASSERT_GREATER_OR_EQUAL_FLOAT((threshold), (actual), \
						 __LINE__, NULL)
...
#define TEST_ASSERT_EACH_EQUAL_DOUBLE(expected, actual, num_elements) \
	UNITY_TEST_ASSERT_EACH_EQUAL_DOUBLE((expected), (actual),     \
					    (num_elements), __LINE__, NULL)
...
#define TEST_ASSERT_GREATER_OR_EQUAL_DOUBLE(threshold, actual)           \
	UNITY_TEST_ASSERT_GREATER_OR_EQUAL_DOUBLE((threshold), (actual), \
						  __LINE__, NULL)
...
#define TEST_ASSERT_LESS_OR_EQUAL_DOUBLE(threshold, actual)           \
	UNITY_TEST_ASSERT_LESS_OR_EQUAL_DOUBLE((threshold), (actual), \
					       __LINE__, NULL)
...
#define TEST_ASSERT_EQUAL_UINT16_MESSAGE(expected, actual, message)    \
	UNITY_TEST_ASSERT_EQUAL_UINT16((expected), (actual), __LINE__, \
				       (message))
#define TEST_ASSERT_EQUAL_UINT32_MESSAGE(expected, actual, message)    \
	UNITY_TEST_ASSERT_EQUAL_UINT32((expected), (actual), __LINE__, \
				       (message))
#define TEST_ASSERT_EQUAL_UINT64_MESSAGE(expected, actual, message)    \
	UNITY_TEST_ASSERT_EQUAL_UINT64((expected), (actual), __LINE__, \
				       (message))
...
#define TEST_ASSERT_BITS_MESSAGE(mask, expected, actual, message)      \
	UNITY_TEST_ASSERT_BITS((mask), (expected), (actual), __LINE__, \
			       (message))
...
#define TEST_ASSERT_NOT_EQUAL_INT_MESSAGE(threshold, actual, message)    \
	UNITY_TEST_ASSERT_NOT_EQUAL_INT((threshold), (actual), __LINE__, \
					(message))
#define TEST_ASSERT_NOT_EQUAL_INT8_MESSAGE(threshold, actual, message)    \
	UNITY_TEST_ASSERT_NOT_EQUAL_INT8((threshold), (actual), __LINE__, \
					 (message))
...
#define TEST_ASSERT_NOT_EQUAL_UINT_MESSAGE(threshold, actual, message)    \
	UNITY_TEST_ASSERT_NOT_EQUAL_UINT((threshold), (actual), __LINE__, \
					 (message))
...
#define TEST_ASSERT_NOT_EQUAL_HEX8_MESSAGE(threshold, actual, message)    \
	UNITY_TEST_ASSERT_NOT_EQUAL_HEX8((threshold), (actual), __LINE__, \
					 (message))
...
#define TEST_ASSERT_NOT_EQUAL_CHAR_MESSAGE(threshold, actual, message)    \
	UNITY_TEST_ASSERT_NOT_EQUAL_CHAR((threshold), (actual), __LINE__, \
					 (message))
...
#define TEST_ASSERT_EQUAL_STRING_MESSAGE(expected, actual, message)    \
	UNITY_TEST_ASSERT_EQUAL_STRING((expected), (actual), __LINE__, \
				       (message))
...
#define TEST_ASSERT_NOT_EQUAL_FLOAT_MESSAGE(expected, actual, message)    \
	UNITY_TEST_ASSERT_NOT_EQUAL_FLOAT((expected), (actual), __LINE__, \
					  (message))
...
#define TEST_ASSERT_FLOAT_IS_NOT_DETERMINATE_MESSAGE(actual, message)  \
	UNITY_TEST_ASSERT_FLOAT_IS_NOT_DETERMINATE((actual), __LINE__, \
						   (message))
...
#define TEST_ASSERT_EQUAL_DOUBLE_MESSAGE(expected, actual, message)    \
	UNITY_TEST_ASSERT_EQUAL_DOUBLE((expected), (actual), __LINE__, \
				       (message))
...
#define TEST_ASSERT_DOUBLE_IS_NOT_DETERMINATE_MESSAGE(actual, message)  \
	UNITY_TEST_ASSERT_DOUBLE_IS_NOT_DETERMINATE((actual), __LINE__, \
						    (message))
...
#define TEST_ASSERT_EQUAL_MESSAGE(expected, actual, message)   \
	UNITY_TEST_ASSERT_EQUAL_MEMORY((&expected), (&actual), \
				       sizeof(expected), __LINE__, message)
#define TEST_ASSERT_NOT_EQUAL_MESSAGE(expected, actual, message) \
	UNITY_TEST_FAIL(__LINE__, UnityStrErrShorthand)
#endif
#ifdef UNITY_SHORTHAND_AS_RAW
