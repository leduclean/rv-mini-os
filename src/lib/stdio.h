...
int snprintf(char *__dest, long unsigned int __size, const char *__format, ...) __attribute__((format (printf, 3, 4)));
int vsprintf(char *__dest, const char *__format, va_list __vl) __attribute__((format (printf, 2, 0)));
int vsnprintf(char *__dest, long unsigned int __size, const char *__format, va_list __vl) __attribute__((format (printf, 3, 0)));
#endif /* __STDIO_H__ */
